---
rule: 0125
title: ADVANCE_BONUS_ALMOST_TOP — what closing it does
...
|---|---|---|---|
| `ADVANCE_BONUS_ALMOST_TOP` | 100, first hit of the bank | lights `ADV_BON_C_TOP`; one bonus if this completes the bank | — |
