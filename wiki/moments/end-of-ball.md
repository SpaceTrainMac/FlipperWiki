...
**915 000 is the ceiling on what a ball *collects*, and not on what a ball is worth.** Everything in
that table is paid when the ball ends; the awards paid *at once* are uncapped, and
[the extra bonus](../concepts/the-extra-bonus.md) alone is 500 000 of them — so a ball that fills
the ladder and takes the extra bonus is worth more than 1 400 000 on its own ([0067](../../raw/rules/0067-915-000-is-the-ceiling-on-what-a.md)).
...
**An extra ball is counted out like any other ball, and then the playfield is cleared for the fresh
one** ([0086](../../raw/rules/0086-an-extra-ball-is-a-fresh-ball-on.md)).
