...
type: thing
aliases: [BUTTON_START, the start button, START]
body: game
---
# The start button

**It belongs to player select and to the high score table, and does nothing during a game** ([0146](../../raw/rules/0146-button_start.md)),
