---
rule: 0439
title: Four events the rules describe still have no cue, and closing one costs five sets a file
...
| **a hole-bonus window expiring** uncollected | same | **the honest gap.** Losing 55 000 to a timer is the harshest thing the rules do and the machine says nothing about it. It wants a cue and none was added, because inventing one costs five sets a file each and nobody has watched a window close |
