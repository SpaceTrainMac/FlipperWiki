...
TBC — what the backlight shows the rest of the time is not a rule here yet, beyond
[the bonus ladders in colour](../things/bonus-ladder.md) ([0027](../../raw/rules/0027-nothing-shows-the-count-as-a-number.md)).
