...
type: thing
aliases: [M, A, C, the M lane, the A lane, the C lane, the top lanes, the outer lanes]
body: game
---
# The M, A and C lanes
...
([0001](../../raw/rules/0001-m-and-c-pay-for-as-long-as-a-is-left-alone.md)). What the letters are
for is [M-A-C](../concepts/m-a-c.md).
